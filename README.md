...
2026 BIFF 공식 상영시간표가 공개되면 `public/screenings.json`을 같은 스키마의 2026 데이터로 교체하고, 작품별 BIFF 공식 URL이 포함되어 있다면 `npm run enrich:genres`로 장르를 채울 수 있습니다. 현재 검색, 필터, 상세보기, 시간표, 예매 상태, 내보내기 기능은 그대로 사용할 수 있습니다. 데이터 교체 시 2025 테스트 데이터는 제거하는 것을 전제로 합니다.
